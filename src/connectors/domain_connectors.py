"""CFO Copilot Agent - Domain-Specific Connectors."""
...
class SnowflakeConnector:
    """Domain-specific connector for snowflake integration with CFO Copilot Agent."""
...
class TableauConnector:
    """Domain-specific connector for tableau integration with CFO Copilot Agent."""
...
class SalesforceConnector:
    """Domain-specific connector for salesforce integration with CFO Copilot Agent."""
...
class WorkdayConnector:
    """Domain-specific connector for workday integration with CFO Copilot Agent."""
...
class JiraConnector:
    """Domain-specific connector for jira integration with CFO Copilot Agent."""
