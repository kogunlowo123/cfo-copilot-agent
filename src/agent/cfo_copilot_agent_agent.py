"""CFO Copilot Agent - Main Agent Implementation."""
...
class CfoCopilotAgentAgent:
    ...
    def __init__(self):
        ...
        self._tool_dispatch = {
            "synthesize_financials": self.tools.synthesize_financials,
            "project_cash_flow": self.tools.project_cash_flow,
            "track_ir_metrics": self.tools.track_ir_metrics,
            "assess_financial_risk": self.tools.assess_financial_risk,
            "recommend_capital_allocation": self.tools.recommend_capital_allocation,
        }
        logger.info(
            "agent_initialized",
            ...
            features=['cfo', 'copilot', 'strategic_insights', 'decision_support'],
        )
    ...
    async def _maybe_execute_tools(self, message: str, context: str) -> list[dict]:
        ...
        tool_keywords = {
            "synthesize_financials": ['synthesize', 'financials'],
            "project_cash_flow": ['project', 'cash', 'flow'],
            "track_ir_metrics": ['track', 'ir', 'metrics'],
            "assess_financial_risk": ['assess', 'financial', 'risk'],
            "recommend_capital_allocation": ['recommend', 'capital', 'allocation'],
        }
